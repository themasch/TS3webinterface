<div>
	...
	<a href="index.php?token">{$lang.head_vserver_token}</a> | <a href="index.php?liveview">{$lang.head_vserver_liveview}</a>
</div>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td><span id="virtualserver_name">{$data.virtualserver_name}</span> <a href="javascript:serveredit('virtualserver_name');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><span id="virtualserver_uptime">{$webinterface->parseTime($data.virtualserver_uptime)}</span>  <a href="javascript:serverupdate(new Array('virtualserver_uptime'));" class="edit"><img src="images/refresh.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_welcomemsg}</b></td>
		<td><span id="virtualserver_welcomemessage">{$data.virtualserver_welcomemessage}</span> <a href="javascript:serveredit('virtualserver_welcomemessage');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_hostmsg}</b></td>
		<td><span id="virtualserver_hostmessage">{$data.virtualserver_hostmessage}</span> <a href="javascript:serveredit('virtualserver_hostmessage');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><span id="virtualserver_needed_identity_security_level">{$data.virtualserver_needed_identity_security_level}</span> {$lang.vsoverview_info_req_securitylvl}<a href="javascript:serveredit('virtualserver_needed_identity_security_level');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	...
	<tr>
		...
		<td><span id="virtualserver_hostbanner_url">{$data.virtualserver_hostbanner_url}</span> <a href="javascript:serveredit('virtualserver_hostbanner_url');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_hostbanner_imgurl}</b></td>
		<td><span id="virtualserver_hostbanner_gfx_url">{$data.virtualserver_hostbanner_gfx_url}</span> <a href="javascript:serveredit('virtualserver_hostbanner_gfx_url');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_hostbanner_buttonurl}</b></td>
		<td><span id="virtualserver_hostbutton_url">{$data.virtualserver_hostbutton_url}</span> <a href="javascript:serveredit('virtualserver_hostbutton_url');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	...
	<tr>
		...
		<td><span id="virtualserver_antiflood_points_needed_warning">{$data.virtualserver_antiflood_points_needed_warning}</span> {$lang.vsoverview_info_antiflood_points} <a href="javascript:serveredit('virtualserver_antiflood_points_needed_warning');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_antiflood_kick}</b></td>
		<td><span id="virtualserver_antiflood_points_needed_kick">{$data.virtualserver_antiflood_points_needed_kick}</span> {$lang.vsoverview_info_antiflood_points} <a href="javascript:serveredit('virtualserver_antiflood_points_needed_kick');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_antiflood_ban}</b></td>
		<td><span id="virtualserver_antiflood_points_needed_ban">{$data.virtualserver_antiflood_points_needed_ban}</span> {$lang.vsoverview_info_antiflood_points} <a href="javascript:serveredit('virtualserver_antiflood_points_needed_ban');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_antiflood_banduration}</b></td>
		<td><span id="virtualserver_antiflood_ban_time">{$data.virtualserver_antiflood_ban_time}</span> {$lang.vsoverview_info_antiflood_in_seconds} <a href="javascript:serveredit('virtualserver_antiflood_ban_time');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
	<tr>
		<td><b>{$lang.vsoverview_info_antiflood_decrease}</b></td>
		<td><span id="virtualserver_antiflood_points_tick_reduce">{$data.virtualserver_antiflood_points_tick_reduce}</span> {$lang.vsoverview_info_antiflood_points_per_tick} <a href="javascript:serveredit('virtualserver_antiflood_points_tick_reduce');" class="edit"><img src="images/edit.png" alt="edit" border="0" /></a></td>
	</tr>
</table>
</fieldset>
